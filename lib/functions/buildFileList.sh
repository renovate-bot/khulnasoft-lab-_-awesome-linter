...
################################################################################
################################################################################
########### Awesome-Linter Build File List Functions @sulaiman-coder ##############
################################################################################
################################################################################
...
function IssueHintForFullGitHistory() {
  ...
  info "See https://github.com/khulnasoft-lab/awesome-linter#example-connecting-github-action-workflow"
}
