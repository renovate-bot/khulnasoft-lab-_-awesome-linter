...
##################################################
control "awesome-linter-installed-packages" do
  impact 1
  title "Awesome-Linter installed packages check"
  desc "Check that packages that Awesome-Linter needs are installed."
...
###########################################
control "awesome-linter-installed-commands" do
  impact 1
  title "Awesome-Linter installed commands check"
  desc "Check that commands that Awesome-Linter needs are installed."
...
############################################
control "awesome-linter-installed-ruby-gems" do
  impact 1
  title "Awesome-Linter installed Ruby gems check"
  desc "Check that Ruby gems that Awesome-Linter needs are installed."
...
###############################################
control "awesome-linter-installed-npm-packages" do
  impact 1
  title "Awesome-Linter installed NPM packages check"
  desc "Check that NPM packages that Awesome-Linter needs are installed."
...
#####################################
control "awesome-linter-validate-directories" do
  impact 1
  title "Awesome-Linter check for directories"
  desc "Check that directories that Awesome-Linter needs are installed."
...
###############################
control "awesome-linter-validate-files" do
  impact 1
  title "Awesome-Linter check for files"
  desc "Check that files that Awesome-Linter needs are installed."
...
###############################
control "awesome-linter-validate-powershell-modules" do
  impact 1
  title "Awesome-Linter validate Powershell Modules"
  desc "Check that Powershell modules that Awesome-Linter needs are installed."
